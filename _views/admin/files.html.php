<div class="no-grid">
	...
	<p>
		<a class="button" href="<?php echo $view->route('admin/files/upload?callback=' . $view->callback) ?>"><?php echo $view->t('Upload files') ?></a>
	</p>
	<?php endif ?>
	...
	<form id="formFile" method="post" action="<?php echo $view->route('admin/files/upload?callback=' . $view->callback) ?>" enctype="multipart/form-data">
		<?php for ( $i = 0; $i < 5; $i ++ ): ?>
		<fieldset>
			<dl>
	...
	<table>
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<a class="button caution" href="<?php echo $view->route('admin/files/delete/' . $file['id'] . '?callback=' . $view->callback) ?>"><?php echo $view->t('Delete') ?></a>
				</td>
				</td>
			</tr>
			<?php endforeach ?>
