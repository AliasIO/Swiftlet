					...
					<tr>
						...
						<td>
							<select name="value[<?php echo $permission['id'] ?>][<?php echo $role['id'] ?>]" id="value_<?php echo $permission['id'] ?>_<?php echo $role['id'] ?>">
								<option value="<?php echo Permission_Plugin::YES   ?>"<?php echo $app->input->POST_html_safe['value'][$permission['id']][$role['id']] == Permission_Plugin::YES   ? ' selected="selected"' : '' ?>><?php echo $view->t('Yes')   ?></option>
								<option value="<?php echo Permission_Plugin::NO    ?>"<?php echo $app->input->POST_html_safe['value'][$permission['id']][$role['id']] == Permission_Plugin::NO    ? ' selected="selected"' : '' ?>><?php echo $view->t('No')    ?></option>
								<option value="<?php echo Permission_Plugin::NEVER ?>"<?php echo $app->input->POST_html_safe['value'][$permission['id']][$role['id']] == Permission_Plugin::NEVER ? ' selected="selected"' : '' ?>><?php echo $view->t('Never') ?></option>
							</select>
						</td>
						<?php endforeach ?>
					</tr>
