...
<div class="no-grid">
	...
	<ul>
		<li><?php echo $this->t('Check out the %sdocumentation%s.', array('<a href="' . $this->rootPath . 'doc">', '</a>')) ?></li>
		<li><?php echo $this->t('Create the configuration file (copy %s to %s).', array('<code>/_config.default.php</code>', '<code>/_config.php</code>')) ?></li>
		<li><?php echo $this->t('Use the %splugin installer%s to install plugins (database connection required).', array('<a href="' . $this->route('installer') . '">', '</a>')) ?></li>
